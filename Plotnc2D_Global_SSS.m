...
%MinVal = -1; MaxVal = 1; CLevelStepVar1 = 0.2;
%MinVal = 5; MaxVal = 30; CLevelStepVar1 = 5;  ICMAP = 2;
MinVal = 31; MaxVal = 37; CLevelStepVar1 = 1; ICMAP = 8;

%RLW = 0; RLE = 360; RLS = -75; RLN = 75; ScreenPos = [68    56   765   452];
RLW = 100; RLE = 280; RLS = -30; RLN = 60; ScreenPos = [86 122 1625 900];
...
%for flipping 
CNL = length(long)/2;
long = circshift(long, CNL); long((end/2+1):end) = long((end/2+1):end)+360;
var = circshift(var, [CNL 0]);



[mlon, mlat] = meshgrid(long(iLong), lati(iLati));
